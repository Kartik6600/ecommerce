...
const Collection = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row pt-4 md:pt-10 border-t border-[#191973] h-full min-h-screen">
      {/* Filter sidebar */}
      <div className={`fixed md:static top-0 left-0 bg-zinc-100 md:bg-transparent z-30 md:z-auto w-3/4 md:w-64 h-full md:h-auto overflow-y-auto md:overflow-visible transition-transform duration-300 ease-in-out ${showFilter ? "translate-x-0" : "-translate-x-full md:translate-x-0"}`}>

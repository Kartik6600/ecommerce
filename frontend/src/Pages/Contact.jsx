    ...
    <div className="py-10">
      ...
      <div className='my-10 flex flex-col justify-center md:flex-row gap-10'>
        <motion.div
          ...
          viewport={{ once: true }}
          className='w-full md:max-w-[480px] border border-[#191973] rounded-lg hover:shadow-xl hover:scale-[1.01] transition-transform duration-300 flex items-center justify-center text-[#191973] bg-sky-50 text-[140px]'
        >
          <FiMessageSquare />
        </motion.div>
        <motion.div
          ...
          transition={{ duration: 0.5 }}
          viewport={{ once: true }}
          className="bg-sky-50 flex flex-col justify-center items-start gap-6 border border-[#191973] rounded-lg p-6 text-[#101049] md:w-2/4"
        >
          <p className="font-semibold text-xl text-[#191973]">Our Store</p>
          <p>Sarkhej - Gandhinagar Highway,<br />Ahmedabad, Gujarat, India</p>
          <p>
            Tel: <a href="tel:+919428242437" className="text-blue-700 hover:underline">+91 9428242437</a><br />
